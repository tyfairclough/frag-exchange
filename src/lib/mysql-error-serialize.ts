/** Walk Error.cause and common mysql/mariadb fields for host logs (no secrets). */
export function serializeDbError(err: unknown, depth = 0): Record<string, unknown> {
  ...
  if (typeof o.sqlState === "string") {
    out.sqlState = o.sqlState;
  }
  if (typeof o.sqlMessage === "string") {
    out.sqlMessage = o.sqlMessage;
  }
