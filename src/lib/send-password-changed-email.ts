...
export async function sendPasswordChangedNoticeEmail(params: {
  ...
  const subject = "Your REEFxCHANGE password was changed";
  ...
  const footerHtml = `<p style="margin:28px 0 0 0;padding-top:20px;border-top:1px solid #e5e7eb;font-size:13px;color:#6b7280">Sent from <a href="${homeHref}" style="color:#374151;text-decoration:underline">REEFxCHANGE</a></p>`;
  ...
  const html = `
    ...
    ${headerBlock}
    <p style="margin:0 0 16px 0">The password for your REEFxCHANGE account was just changed.</p>
  ...
  const text = [
    "The password for your REEFxCHANGE account was just changed.",
    "",
